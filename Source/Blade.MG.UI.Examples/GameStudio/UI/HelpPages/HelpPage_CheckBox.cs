        ...
        protected override void InitTemplate()
        {
            ...
            layoutPanel.AddChild(
                new PageHeader()
                {
                    ...
                    Title = "Check Boxes",
                    Description = "CheckBox states: two-state, tri-state (indeterminate), disabled, and custom icons."
                });
            ...
            // Row 0: built-in check states
            grid.AddChild(BuildField(new CheckBox()
            {
                Text = "Two-State",
                Tristate = false,
                IsEnabled = true,
            ...
            // Row 1: custom checkbox icons
            grid.AddChild(BuildField(new CheckBox()
            {
                Text = "Custom Icon (checked)",
                Tristate = false,
                IsEnabled = true,
                IsChecked = true,
                CheckedIcon = StarIconPath,
                UncheckedIcon = StarIconPath,
                HorizontalAlignment = HorizontalAlignmentType.Left,
                VerticalAlignment = VerticalAlignmentType.Center,
            }), 0, 1);
