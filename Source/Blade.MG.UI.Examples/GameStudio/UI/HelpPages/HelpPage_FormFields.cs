...
namespace Examples.UI.HelpPages
{
    ...
    {
        // A single glyph (star) reused for the custom-icon CheckBox example below.
        ...
        protected override void InitTemplate()
        {
            ...
            layoutPanel.AddChild(
                new PageHeader()
                {
                    ...
                    Title = "Form Fields",
                    Description = "TextBox variants, CheckBox states, and custom checkbox icons."
                });
            ...
            // Row 2: Custom checkbox icons, and a closing action to round out the "form".
            grid.AddChild(BuildField(new CheckBox()
            {
