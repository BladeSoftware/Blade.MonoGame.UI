...
//using GameStudio.UI.Editors;
//using Microsoft.Xna.Framework;
//using System.Collections.Generic;

//namespace Examples.UI
//{
//    public class ProjectUI : UIWindow
//    {
...
//        {
//            //var grid = Children.FirstOrDefault();

//            //if (grid != null)
//            //{
//            //    grid.Transform = grid.Transform with { Rotation = grid.Transform.Rotation + new Vector3(0f, 0f, 0.1f) };
//            //}
...
//                Background = new Color(Color.Green, 1f),
